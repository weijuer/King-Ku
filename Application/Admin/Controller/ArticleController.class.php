...
//		    'text' => array('.listbox > #tt1','text'),
		    //采集class为two下面的超链接的链接
		    'link' => array('.me2li>a','href'),
		    //采集class为two下面的第一张图片的链接
		    'img' => array('.me2li>a>img','src'),
		    //采集span标签中的HTML内容
		    'title' => array('.me2li>a','title')
		);
		$page = 'http://www.80s.tw/'; // 采集地址
		$range = '#tt1'; // 区域选择器
...
//		import('QL.phpQuery'); // 导入phpQuery类库
//		
//		//需要采集的目标页面
